...
module.exports = function (client) {
    ...
    return {
      ...
      create: function(projectKey, repoSlug, pullRequestId, data) {
        return client.post('projects/' + projectKey + '/repos/' + repoSlug + '/pull-requests/', data);
      },

      get: function(projectKey, repoSlug, pullRequestId) {
        return client.post('projects/' + projectKey + '/repos/' + repoSlug + '/pull-requests/' + pullRequestId);
      },
