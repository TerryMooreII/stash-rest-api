...
module.exports = function (client) {
    ...
    return {
      ...
      unapprove: function(projectKey, repoSlug, pullRequestId) {
        return client.delete('projects/' + projectKey + '/repos/' + repoSlug + '/pull-requests/' + pullRequestId + '/approve');
      },

      approve: function(projectKey, repoSlug, pullRequestId) {
        return client.post('projects/' + projectKey + '/repos/' + repoSlug + '/pull-requests/' + pullRequestId + '/approve');
      },

      changes: function(projectKey, repoSlug, pullRequestId, options) {
        options = options || {};
        options.args = utils.defaults(options.args || {}, { 'limit': 1000 });
      ...
      participantsDelete: function(projectKey, repoSlug, pullRequestId, username) {
